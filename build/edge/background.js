// background.js - Edge-compatible version
    ...
    if (alarm.name.startsWith('reminder-')) {
      ...
      chrome.storage.sync.get(['reminders'], function(result) {
        ...
        if (reminder && !reminder.completed) {
          // Show notification - Edge-compatible approach
          try {
            ...
            // Fallback notification method if needed
            alert(`Reminder: ${reminder.title} - ${reminder.description || 'Your reminder is due!'}`);
          }
